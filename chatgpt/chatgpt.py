...
from chatgpt.utils.config import conf
...
class OpenAIBot():
    ...
    # call chatgbt (in use)
    def chatwithGpt(self, query=None):
    ...
    def combine_session(content):
        ...
        for conversation in content:
            if(i%2 == 0):
                ...
                prompt += "\n\n\nAI : " + conversation["content"] + "<|im_end|>\n"
            i+=1
        prompt += "\nAI: "
